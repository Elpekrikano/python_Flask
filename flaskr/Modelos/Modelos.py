...
class Album(db.Model):
    ...
    def _repr_(self):
        return "{}-{}-{}-{}-{},{}".format(self.titulo, self.anio, self.descripcion, self.medio, self.usuario, self.canciones)
...
class Usuario(db.Model):
    ...
    def _repr_(self):
        return "{}-{}-{}".format(self.nombre_usuario, self.contrasena, self.albumes)
